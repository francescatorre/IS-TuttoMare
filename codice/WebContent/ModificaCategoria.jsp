...
<% if(categorie!=null&& categorie.size()!=0){
    	...
    	<tr> 
    	   ...
    	   <td><a href="ModificaCategoriaS?action=cancella&id=<%=bean.getIdCategoria()%>">Rimuovi Categoria</a> <br>
    	   <a href="CategoriaControl?action=modifica&id=<%=bean.getIdCategoria()%>">Modifica Categoria</a>
