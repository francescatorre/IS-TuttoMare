...
<% if(sottoC!=null&& sottoC.size()!=0){
    	...
    	<tr> 
    	   ...
    	   <td><a href="ModificaSottoCS?action=cancella&id=<%=bean.getIdSottoCategoria()%>" class="a">Rimuovi Sotto Categoria</a> <br>

    	   <a href="SottoCatControl?action=modifica&id=<%=bean.getIdSottoCategoria()%>" class="a">Modifica Sotto Categoria</a>
