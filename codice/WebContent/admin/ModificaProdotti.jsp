...
<% if(prodotti!=null&& prodotti.size()!=0){
    	...
    	<tr> 
    	   ...
    	   <td><a href="ModificaProdottoS?action=cancella&id=<%=bean.getIdProdotto()%>" class="a">Rimuovi Prodotto</a> <br> <br>
    	   <a href="ProdottiControl?action=modifica&id=<%=bean.getIdProdotto()%>" class="a">Modifica Prodotto</a>
