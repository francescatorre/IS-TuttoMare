...
<% 
ProdottiData prodotto=(ProdottiData)request.getAttribute("prodotto"); 
%>
...
<h1 class="h1">Prodotto che stai acquistando</h1>
...
<form action="DatiAcquisto" class="FormAcquisti col-12 col-m-12" method="post">
	...
	<div class="quantita_P col-2 col-m-2">
		<p class="Quantita">Quantita <br> 1 </p>
	</div>
...
if(listaSpedizione!=null&& listaSpedizione.size()!=0){
 ...
 %>
  ...
  <tr>
     ...
     <td> <input type="radio" name="spedizione" value="<%=data.getIdSpedizione()%>" required="required" style="background-image:url('icone/false.png');background-position:center;font-size: 0px; height: 20px;"></td>
</tr>
